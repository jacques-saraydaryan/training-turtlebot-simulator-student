...
#### For simulator install only 
  - If Simulator is not installed check prerequisite of [install and use](../quick-start.md).
...
Try to make several tries of navigation with different configurations.
